    ...
    return (
        <>
            <header className={`full header ${(isFilterExpanded) ? "expanded" : ""} ${(layout === 'main-container narrow') ? "narrow" : ""}`} >
                    ...
                    <div className='first-row-header' >
                        ...
                        <div className="user-info">
                            ...
                            <button onClick={openUserModal} className='btn-user'>
                                ...
                                {/* <img src={user ? user.imgUrl : require(`../assets/user-img/japanese.jpg`)} alt="" /> */}
                            </button>
                        ...
                        <StayFilterExpanded isGuestModalOpen={isGuestModalOpen} isWhereModalOpen={isWhereModalOpen} isDateModalOpen={isDateModalOpen}
                            onAddGuest={onAddGuest} onAddWhere={onAddWhere} onDateModal={onDateModal} whoCounter={whoCounter} setWhoCounter={setWhoCounter} />
                    </div>
                ...
                {!isFilterExpanded && <NavIconFilter layout={layout} showIconNav={showIconNav} />}
            </header>
